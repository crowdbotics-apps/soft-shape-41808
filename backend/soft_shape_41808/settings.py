"""
Django settings for soft_shape_41808 project.
...
ROOT_URLCONF = 'soft_shape_41808.urls'
...
WSGI_APPLICATION = 'soft_shape_41808.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "soft_shape_41808 API",
    "DESCRIPTION": "API documentation for soft_shape_41808 App",
    "VERSION": "v1",
}
